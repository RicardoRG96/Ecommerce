...
{
    /// <inheritdoc />
    public partial class Create_Database_With_Identity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Apartament = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddressUser", x => new { x.AddressId, x.ApplicationUserId });
                    table.ForeignKey(
                        name: "FK_AddressUser_Address_AddressId",
