    ...
    public class UnassignPermissionToRoleTests : BaseFunctionalTest
    {
        ...
        public async Task Should_ReturnBadRequest_WhenRoleNameIsMissing()
        {
            ...
            HttpResponseMessage response =
                await HttpClient.PostAsJsonAsync($"{ApiRoutes.Admin.Roles}/permissions/unassign", invalidRequest);
        ...
        public async Task Should_ReturnNoContent_WhenRequestIsValidAndUserIsLoggedIn()
        {
            ...
            await HttpClient.PostAsJsonAsync($"{ApiRoutes.Admin.Roles}/permissions/assign", _assignPermissionRequest);

            HttpResponseMessage response =
                await HttpClient.PostAsJsonAsync($"{ApiRoutes.Admin.Roles}/permissions/unassign", _request);
