...
namespace Application.UnitTests.Products.Attributes.Deactivate
{
    public class DeactivateAttributeCommandTests
    {
        private const long AttributeId = 1;

        private static readonly DeactivateAttributeCommand _command = new(AttributeId);

        private readonly DeactivateAttributeCommandHandler _handler;
        private readonly IAttributeRepository _attributeRepositoryMock;
        private readonly IUnitOfWork _unitOfWorkMock;

        public DeactivateAttributeCommandTests()
        {
        ...
        #region Active Attribute Scenarios

        [Fact]
        public async Task Handle_Should_ReturnSuccess_WhenAttributeIsActive()
        {
            // Arrange
        ...
        [Fact]
        public async Task Handle_Should_DeactivateAttribute_WhenAttributeIsActive()
        {
            // Arrange
            Domain.Entities.Products.Attribute attribute = CreateActiveAttribute();
            SetupAttributeFound(attribute);
        ...
        [Fact]
        public async Task Handle_Should_CallUpdate_WhenAttributeIsActive()
        {
            // Arrange
            Domain.Entities.Products.Attribute attribute = CreateActiveAttribute();
            SetupAttributeFound(attribute);
        ...
        [Fact]
        public async Task Handle_Should_CallUpdateWithCorrectAttribute_WhenAttributeIsActive()
        {
            // Arrange
            Domain.Entities.Products.Attribute attribute = CreateActiveAttribute();
            SetupAttributeFound(attribute);
        ...
        [Fact]
        public async Task Handle_Should_CallSaveChangesAsync_WhenAttributeIsActive()
        {
            // Arrange
            Domain.Entities.Products.Attribute attribute = CreateActiveAttribute();
            SetupAttributeFound(attribute);
        ...
        [Fact]
        public async Task Handle_Should_CallSaveChangesAsync_AfterUpdate_WhenAttributeIsActive()
        {
            // Arrange
            Domain.Entities.Products.Attribute attribute = CreateActiveAttribute();
            SetupAttributeFound(attribute);
        ...
        #region Already Inactive Attribute Scenarios

        [Fact]
        public async Task Handle_Should_ReturnSuccess_WhenAttributeIsAlreadyInactive()
        {
            // Arrange
        ...
        [Fact]
        public async Task Handle_Should_NotChangeIsActive_WhenAttributeIsAlreadyInactive()
        {
            // Arrange
            Domain.Entities.Products.Attribute attribute = CreateInactiveAttribute();
            SetupAttributeFound(attribute);
        ...
        [Fact]
        public async Task Handle_Should_NotCallUpdate_WhenAttributeIsAlreadyInactive()
        {
            // Arrange
            Domain.Entities.Products.Attribute attribute = CreateInactiveAttribute();
            SetupAttributeFound(attribute);
        ...
        [Fact]
        public async Task Handle_Should_NotCallSaveChangesAsync_WhenAttributeIsAlreadyInactive()
        {
            // Arrange
            Domain.Entities.Products.Attribute attribute = CreateInactiveAttribute();
            SetupAttributeFound(attribute);
        ...
        public async Task Handle_Should_ReturnFailure_WhenDifferentAttributeIdDoesNotExist()
        {
            ...
            var command = new DeactivateAttributeCommand(nonExistentAttributeId);
        ...
        [Fact]
        public async Task Handle_Should_OnlyModifyIsActiveProperty_WhenDeactivatingAttribute()
        {
            // Arrange
            Domain.Entities.Products.Attribute attribute = CreateActiveAttribute();
